...
class PoeOAuthClient:
    ...
    # Note: Using 127.0.0.1 for PUBLIC CLIENT (localhost not allowed for confidential)
    ...
    def __init__(
        ...
        self.token_file = token_file or Path.home() / ".poe_price_checker" / "oauth_token.json"
    ...
    def authenticate(self) -> bool:
        ...
        """
        self.logger.info("Starting OAuth authentication flow (PUBLIC CLIENT with PKCE)")
    ...
    def _exchange_code_for_token(self, code: str) -> bool:
        ...
        try:
            ...
            self.logger.info("Got access token, expires in %d seconds", expires_in)
    ...
    def refresh_access_token(self) -> bool:
        ...
        try:
            ...
            self.logger.info("Refreshed access token, expires in %d seconds", expires_in)
