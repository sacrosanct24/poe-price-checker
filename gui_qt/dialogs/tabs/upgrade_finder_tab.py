"""
Upgrade Finder Tab for Item Planning Hub.

Tab widget for finding gear upgrades within a budget constraint.
Extracted from UpgradeFinderDialog for unified planning experience.
"""
...
if TYPE_CHECKING:
    ...
    from core.upgrade_finder import UpgradeFinderService, UpgradeFinderResult, UpgradeCandidate
...
class UpgradeFinderTab(QWidget):
    """
    Tab widget for finding gear upgrades.
    ...
    def _create_widgets(self) -> None:
        ...
        settings_layout.addLayout(slots_row)
        ...
        self.results_table.setStyleSheet(f"""
            ...
            QTableWidget::item:selected {{ background-color: {COLORS["accent_blue"]}; }}
            QHeaderView::section {{
    ...
    def _init_service(self) -> None:
        ...
        try:
            from core.upgrade_finder import UpgradeFinderService
    ...
    def _show_no_results(self) -> None:
        ...
        self.details_browser.setHtml(f"""
            <p style="color: {COLORS['text_secondary']}; text-align: center; margin-top: 40px;">
                Configure your search settings and click "Find Upgrades" to search.
            </p>
        """)
        self.summary_label.setText(
            "Set your budget, select equipment slots, and search for upgrades."
        )
